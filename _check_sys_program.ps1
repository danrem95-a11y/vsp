...
Tab "select top 3 * from SYS_PROGRAM" "1. Struktur kolom SYS_PROGRAM (contoh 3 baris)"
Tab "select * from SYS_PROGRAM where program_id like '%refresh%' or program_id like '%journal%' or program_name like '%refresh%' or program_name like '%journal%' or program_name like '%Journal%'" "2. Cari baris terkait refresh/journal (coba nama kolom umum)"
$c.Close()
