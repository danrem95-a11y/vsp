...
# Daftar akun persediaan yg akan direkap (dari engine PERSEDIAAN field)
Tab "select distinct account_id from gl_journal where account_id like '102-%' order by 1" "0. Daftar akun 102-xxx yg ada di GL (utk scope rekap)"
$c.Close()
