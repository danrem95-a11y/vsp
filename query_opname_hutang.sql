...
(
    ...
    (
        ...
        /* Ambil detail properties: AP_TRANS untuk 4SL.xxx, SALDO_AWAL_FAKTUR sebagai fallback untuk 200.xxx */
    ...
    /* SUBQUERY LALU-3: REKAP PEMBAYARAN SEBELUM BULAN BERJALAN (dalam tahun berjalan) */
    LEFT JOIN
    (
        SELECT
            T2.BUKTI_ID,
