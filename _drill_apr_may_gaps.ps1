...
# Breakdown per item 102-001 April
...
"@
Tab $q1 "1. Item 102-001 April kontributor gap (selisih>Rp100)"

# Breakdown per item 102-003 Mei
...
"@
Tab $q2 "2. Item 102-003 Mei kontributor gap (selisih>Rp100)"
$c.Close()
