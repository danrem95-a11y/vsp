...
SUM( CASE WHEN TSTOK1.TIPE_TRANS = '88' THEN (TSTOK2.NETTO * ISNULL(TSTOK1.KURS,1))    ELSE 0 END) AS CONSIN,
							...
							SUM( CASE WHEN TSTOK1.TIPE_TRANS = '19' THEN ABS(TSTOK2.QTY * ISNULL((SELECT MAX(SV.HPP_AVG) FROM SINV SV WHERE SV.STOK_ID=TSTOK2.STOK_ID AND SV.PERIODE='2026-05-01'),0)) ELSE 0 END ) AS MUTASI_OUT,
