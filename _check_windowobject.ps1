...
Tab "select * from sysleftmenu where lower(windowobject) like '%refresh%'" "1. Semua entri menu dgn windowobject mengandung 'refresh'"
Tab "select * from sysleftmenu where lower(windowobject) = 'w_refresh_journal'" "2. Entri PERSIS w_refresh_journal"
Tab "select * from sysleftmenu where lower(windowobject) like '%journal%'" "3. Entri mengandung 'journal' (siapa tau nama beda)"
$c.Close()
