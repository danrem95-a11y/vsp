...
foreach($per in @(@('Jan','2026-01-01','2026-01-31','2026-02-01'), @('Feb','2026-02-01','2026-02-28','2026-03-01'), @('Mar','2026-03-01','2026-03-31','2026-04-01'))){
...
Write-Host ""; Write-Host "===== INV-03 outstanding WIP-Out vs GL 102-020 (informasional) ====="
foreach($eom in @('2026-01-31','2026-02-28','2026-03-31')){
