...
# Cari nama tabel yg mengandung 'menu' atau 'program' di seluruh schema
Tab @"
select table_name from sys.systable
 where table_name like '%MENU%' or table_name like '%PROGRAM%' or table_name like '%SYS_%'
 order by table_name
"@ "1. Daftar tabel terkait menu/program di database"
$c.Close()
